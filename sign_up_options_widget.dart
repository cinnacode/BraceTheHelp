...
import 'sign_up_options_model.dart';
export 'sign_up_options_model.dart';
            ...
            child: Column(
              ...
              children: [
                Stack(
                  children: [
                    Image.asset(
                      'assets/images/BRACE_THE_HELP.png',
                      width: 400,
                      height: 400,
                      fit: BoxFit.cover,
                    ),
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      context.pushNamed('signUpPatient');
                    },
                    text: 'Patient Signup',
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      context.pushNamed('signUpCaretaker');
                    },
                    text: 'Caretaker Signup',
                    options: FFButtonOptions(
                      width: 200,
                      height: 40,
                      color: FlutterFlowTheme.of(context).primaryColor,
